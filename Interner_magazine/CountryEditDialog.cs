...
{
    public class CountryEditDialog : Window
    {
        ...
        public CountryEditDialog(Country country)
        {
            ...
            InitializeComponents(country);
        }

        private void InitializeComponents(Country country)
        {
            Grid grid = new Grid();
            ...
            txtName = new TextBox { Text = country.NameCountry, Margin = new Thickness(0, 0, 0, 20) };
